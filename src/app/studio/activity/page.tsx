...
export default async function StudioActivityPage(
  props: { searchParams: Promise<{ q?: string; admin?: string; action?: string; entity?: string; from?: string; to?: string; page?: string }> }
) {
